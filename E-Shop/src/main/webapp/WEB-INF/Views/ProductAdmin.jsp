                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            ...
                            <form:form class="form-horizontal form-material" action="AddProduct" modelAttribute="product" enctype="multipart/form-data">
                         <form:hidden path="pid"/>
                             <div class="form-group mb-4">
                                   ...
                                   <div class="row mb-3">
                                    <form:label path="productname" class="col-sm-2 col-form-label">Name</form:label>
									...
									<form:input path="company"/>                                    
			                         ...
			                         <div class="row mb-3">
			                        <form:label path="qty" class="col-sm-2 col-form-label">Quantity</form:label>
			                        <form:input path="qty"/>
			                        </div>
